            ...
            <div class="card border-0">
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" class="mt-4" role="form">
						...
						<div class="form-group">
                            <label><?= $this->language->register->form->phone ?></label>
                            <input type="text" name="phone" class="form-control" value="<?= $data->values['phone'] ?>" placeholder="<?= $this->language->register->form->phone_placeholder ?>" required="required" />
                        </div>
