...
<?php 
if($data->is_main_url){
require THEME_PATH . 'views/partials/ads_header.php';
}
?>
<?php $error = isset($_SESSION['error']) && !empty($_SESSION['error']) ? $_SESSION['error'][0] : null ?>
<div class="container">
    <div class="d-flex flex-column align-items-center">
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-5">
            ...
            <div class="card border-0">
                <div class="card-body p-5">
                    <h4 class="card-title text-center"><?= $this->language->login->header ?></h4>
        ...
        <?php $this->settings->register_is_enabled=false; if($this->settings->register_is_enabled): ?>
