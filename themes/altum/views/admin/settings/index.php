...
<div class="row mt-5">
    <div class="mb-5 mb-lg-0 col-12 col-lg-3">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" href="#filters" data-toggle="pill" role="tab"><i class="fa fa-fw fa-sm fa-key fa-sm mr-1"></i>Filter Words</a>
			...
			<?php if($this->user->type==1 && (empty($this->user->agency) && empty($this->user->subagency))) {?>
			<a class="nav-link" href="#whatsapp_notifications" data-toggle="pill" role="tab"><i class="fab fa-fw fa-whatsapp fa-sm mr-1"></i> <?= $this->language->admin_settings->tab->whatsapp_notifications ?></a>
            <?php }?>
                ...
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            ...
                            <div class="form-group">
                                ...
                                <?php if($this->settings->logo != ''): ?>
                                    <div class="m-1">
                                        <img src="<?= SITE_URL . UPLOADS_URL_PATH . 'logo/' . $this->settings->logo ?>" class="img-fluid navbar-logo" />
                                    </div>
                                <?php endif ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if($this->settings->favicon != ''): ?>
                                    <div class="m-1">
                                        <img src="<?= SITE_URL . UPLOADS_URL_PATH . 'favicon/' . $this->settings->favicon ?>" class="img-fluid" />
                                    </div>
                                <?php endif ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="register_is_enabled">
                        ...
                        <div class="tab-pane fade" id="filters">
							...
							<div class="form-group">
                                <label><?= $this->language->admin_settings->filter->label ?></label>
                                <textarea type="text" name="filter_filter_words" class="form-control" rows="15" placeholder="<?= $this->language->admin_settings->filter->filter_placeholder ?>"><?= get_raw_filter_words() ?></textarea>
                            </div>
                        ...
                        <div class="tab-pane fade" id="links">
                            <div class="form-group">
                                ...
                                <select name="links_shortener_is_enabled" class="form-control">
                                    <option value="1" <?= $this->settings->links->shortener_is_enabled ? 'selected' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->links->shortener_is_enabled ? 'selected' : null ?>><?= $this->language->global->no ?></option>
                                </select>
                                <small class="text-muted"><?= $this->language->admin_settings->links->shortener_is_enabled_help ?></small>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->links->domains_is_enabled ?></label>

                                <select name="links_domains_is_enabled" class="form-control">
                                    <option value="1" <?= $this->settings->links->domains_is_enabled ? 'selected' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->links->domains_is_enabled ? 'selected' : null ?>><?= $this->language->global->no ?></option>
                                </select>
                                <small class="text-muted"><?= $this->language->admin_settings->links->domains_is_enabled_help ?></small>
                            </div>
                            ...
                            <h4><i class="fa fa-fw fa-fish fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->links->phishtank ?></h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="links_phishtank_is_enabled" class="form-control">
                            ...
                            <h4><i class="fab fa-fw fa-google fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->links->google_safe_browsing ?></h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="links_google_safe_browsing_is_enabled" class="form-control">
                        ...
                        <div class="tab-pane fade" id="payment">
                            <?php if(!in_array(isset($this->settings->license->type) ? $this->settings->license->type : null, ['SPECIAL','Extended License'])): ?>
                            ...
                            <div class="<?= !in_array($this->settings->license->type, ['SPECIAL','Extended License']) ? 'container-disabled' : null ?>">
                                <div class="form-group">
                                    ...
                                    <select name="payment_is_enabled" class="form-control">
                                ...
                                <h4><i class="fab fa-fw fa-paypal icon-paypal fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->payment->paypal ?></h4>
                                ...
                                <h4><i class="fab fa-fw fa-stripe icon-stripe fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->payment->stripe ?></h4>
                        ...
                        <div class="tab-pane fade" id="ads">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="ads_header_biolink"><?= $this->settings->ads->header_biolink ?></textarea>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->ads->footer_biolink ?></label>
                                <textarea class="form-control" name="ads_footer_biolink"><?= $this->settings->ads->footer_biolink ?></textarea>
                            </div>
                        </div>

                        <div class="tab-pane fade" id="captcha">
                            <h4><i class="fab fa-fw fa-google fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->captcha->recaptcha ?></h4>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->captcha->recaptcha_is_enabled ?></label>

                                <select name="captcha_recaptcha_is_enabled" class="form-control">
                        ...
                        <div class="tab-pane fade" id="facebook">
                            <div class="form-group">
                                ...
                                <select name="facebook_is_enabled" class="form-control">
                        ...
                        <div class="tab-pane fade" id="socials">
                            ...
                            <?php foreach(require APP_PATH . 'includes/admin_socials.php' AS $key => $value): ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="socials_<?= $key ?>" class="form-control" value="<?= $this->settings->socials->{$key} ?>" />
                                </div>
                            <?php endforeach ?>
                        </div>
						...
						<div class="tab-pane fade" id="whatsapp_notifications">

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->whatsapp_notifications->whatsapps ?></label>
                                <textarea class="form-control" name="whatsapp_notifications_whatsapps" rows="5"><?= isset($this->settings->whatsapp_notifications->whatsapps) ? stripcslashes($this->settings->whatsapp_notifications->whatsapps) : null ?></textarea>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->whatsapp_notifications->whatsapps_help ?></small>
                            </div>
							
							 <div class="form-group">
                                <label><?= $this->language->admin_settings->whatsapp_notifications->api_key ?></label>
                                <input class="form-control" name="whatsapp_notifications_api_key" value="<?= isset($this->settings->whatsapp_notifications->api_key) ? $this->settings->whatsapp_notifications->api_key : null ?>" placeholder="<?= $this->language->admin_settings->whatsapp_notifications->api_key_help ?>" />
                            </div>

                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="whatsapp_notifications_new_user" <?= isset($this->settings->email_notifications->new_user) ? ($this->settings->email_notifications->new_user ? 'checked' : null) : null?>>
                                    <?= $this->language->admin_settings->whatsapp_notifications->new_user ?>
                                </label>

                                <small class="form-text text-muted"><?= $this->language->admin_settings->whatsapp_notifications->new_user_help ?></small>
                            </div>

                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="whatsapp_notifications_new_payment" <?= isset($this->settings->whatsapp_notifications->new_payment) ? ($this->settings->whatsapp_notifications->new_payment ? 'checked' : null) : null?>>
                                    <?= $this->language->admin_settings->whatsapp_notifications->new_payment ?>
                                </label>

                                <small class="form-text text-muted"><?= $this->language->admin_settings->whatsapp_notifications->new_payment_help ?></small>
                            </div>
                        ...
                        <div class="tab-pane fade" id="license">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="license_new_license" value="" />
