...
<div class="d-flex justify-content-between">
    <h1 class="h3 mr-3"><i class="fa fa-fw fa-xs fa-box-open text-gray-700"></i> <?= $this->language->admin_package_create->header ?></h1>
</div>
    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="row">
				...
				<div class="col-12">
                    <div class="form-group">
                        <label><?= $this->language->admin_packages->input->is_trial ?></label>
				...
				<div class="col-6">
                    <div class="form-group form-nwoption" style="display:none">
            ...
            <div class="form-group" <?= !$this->settings->links->domains_is_enabled ? 'style="display: none"' : null ?>>
                ...
                <input type="number" id="domains_limit" name="domains_limit" min="-1" class="form-control" value="" />
			...
			<div class="custom-control custom-switch mb-3">
                <input id="exclude_agency" name="exclude_agency" type="checkbox" class="custom-control-input">
