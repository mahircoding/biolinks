...
<div class="d-flex justify-content-between">
    <h1 class="h3 mr-3"><i class="fa fa-fw fa-xs fa-tags text-gray-700"></i> <?= $this->language->admin_code_create->header ?></h1>
</div>
                ...
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <select id="package_id" name="package_id" class="form-control form-control-lg">
                            ...
                            <option value=""><?= $this->language->admin_codes->main->package_id_null ?></option>
                        </select>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <div id="days_container" class="form-group">
                                ...
                                <input type="number" min="1" id="days" name="days" class="form-control form-control-lg" value="1" />
