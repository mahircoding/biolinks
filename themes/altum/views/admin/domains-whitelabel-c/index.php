...
<div class="d-flex justify-content-between">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-anchor text-gray-700"></i> Add White Label Domain</h1>
</div>
        ...
        <form action="" method="post" role="form">
			...
			<div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="url" placeholder="<?= $this->language->admin_domain_create->form->host_placeholder ?>" required="required" />
                </div>
