...
<ul class="mt-5 nav nav-custom">
	...
	<li class="nav-item">
        <a href="<?= url('bank-account') ?>" class="nav-link <?= \Altum\Routing\Router::$controller_key == 'bank-account' ? 'active' : null ?>">
            <i class="fas fa-fw fa-sm fa-landmark mr-1"></i> <?= $this->language->bank_account->menu ?>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a href="<?= url('domains') ?>" class="nav-link <?= \Altum\Routing\Router::$controller_key == 'domains' ? 'active' : null ?>">
            <i class="fa fa-fw fa-sm fa-anchor mr-1"></i> <?= $this->language->domains->menu ?>
        </a>
    </li>
    <?php endif ?>
    ...
    <li class="nav-item">
        <a href="<?= url('account-package') ?>" class="nav-link <?= \Altum\Routing\Router::$controller_key == 'account-package' ? 'active' : null ?>">
            <i class="fa fa-fw fa-sm fa-box-open mr-1"></i> <?= $this->language->account_package->menu ?>
        </a>
    </li>
    ...
    <?php if($this->user->type == 1 || $this->user->addon_digital_products == '1') :?>
    <li class="nav-item">
