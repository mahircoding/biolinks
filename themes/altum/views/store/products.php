...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <h2 class="h4 mb-4">All Products</h2>
                        ...
                        <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    <?php if($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="<?= url('store/' . $user->username . '/products?page=' . ($page - 1)) ?>" aria-label="Previous">
                                    ...
                                    <?php for($i = $start_range; $i <= $end_range; $i++): ?>
                                        <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                                            <a class="page-link" href="<?= url('store/' . $user->username . '/products?page=' . $i) ?>"><?= $i ?></a>
                                        </li>
                                    <?php endfor; ?>
                                    
                                    <?php if($page < $total_pages): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="<?= url('store/' . $user->username . '/products?page=' . ($page + 1)) ?>" aria-label="Next">
