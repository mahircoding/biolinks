...
<div class="my-3 category-product">
    ...
    <!-- Product Detail Modal (Improved Layout) -->
            ...
            <div class="d-flex flex-column flex-md-row h-100 overflow-auto">
                ...
                <div class="col-12 col-md-6 p-0 bg-light border-bottom border-md-bottom-0 border-md-right">
                    <div class="p-3 d-flex flex-column align-items-center h-100">
                        ...
                        <!-- Thumbnails -->
                        <div id="thumbnailGallery" class="d-flex flex-wrap justify-content-center gap-2 w-100 pb-2">
                            <!-- Generated by JS -->
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-4 d-flex flex-column bg-white">
                    ...
                    <div id="modalProductVariants" class="mb-4">
                        <!-- Variants JS -->
                    </div>
                    
                    <div id="modalProductDesc" class="text-secondary small mb-4 flex-grow-1" style="white-space: pre-wrap; overflow-y: auto; line-height: 1.6;">
                    </div>
            ...
            btn.addEventListener('click', function() {
                ...
                if(images.length > 0) {
                    ...
                    images.forEach((imgUrl, idx) => {
                        ...
                        thumb.src = imgUrl;
                        // Improved Styling: White bg, padding, rounded
                ...
                // Handle Variants (Improved Logic)
                        ...
                        if(variantGroup.variant && variantGroup.variant.length > 0) {
                            variantGroup.variant.forEach((opt, oIndex) => {
                                ...
                                btn.onclick = function() {
                                    // Remove active class from siblings and make them outline
                                    this.parentElement.querySelectorAll('.btn').forEach(b => {
                                        b.classList.remove('btn-primary');
                                        b.classList.add('btn-outline-secondary');
                                    });
                                    // Make this button solid primary
    ...
    <style>
        /* Fixes for Bootstrap 3/4/5 Compatibility */
